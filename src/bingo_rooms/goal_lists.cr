module BingoRooms::GoalLists
  SPYRO_2__4_1 = [
    [
      ...
      { name: "4+ orbs in Hurricos & Magma Cone", types: [] of String },
      { name: "Speak to all 9 instances of Zoe", types: [] of String },
    ...
    [
      ...
      { name: "5+ orbs in Breeze Harbour and Zephyr", types: [] of String },
      { name: "Buy Climb & Headbash", types: [] of String },
      { name: "Use all invincibility powerups", types: [] of String },
    ...
    [
      ...
      { name: "Break 3 Mystery Jars", types: [] of String },
      { name: "600 combined gems in Skelos Badlands & Shady Oasis", types: [] of String },
    ...
    [
      ...
      { name: "250 gems in both Zephyr and Shady Oasis", types: [] of String },
      { name: "Use all supercharge powerups", types: [] of String },
      { name: "10 Autumn Plains orbs", types: [] of String },
      { name: "100% Crystal Glacier", types: ["max2"] }
    ],
    [
      { name: "Unlock all speedways", types: [] of String },
      { name: "All gems in 3 speedways", types: [] of String },
      { name: "All gems in 3 speedways", types: [] of String },
      { name: "Ocean & Canyon orbs", types: [] of String },
      { name: "Ocean & Metro orbs", types: [] of String },
      { name: "Metro & Icy orbs", types: [] of String },
      { name: "Icy & Canyon orbs", types: [] of String },
      { name: "Unlock all speedways", types: [] of String }
    ],
    [
    ...
    [
      ...
      { name: "8 Winter Tundra orbs", types: [] of String },
    ...
    [
      ...
      { name: "Talismans in Hurricos, Scorch & Magma Cone", types: [] of String },
      { name: "Talismans in Idol Springs, Zephyr & Shady Oasis", types: [] of String },
      { name: "Talismans in Colossus, Aquaria Towers & Breeze Harbor", types: [] of String },
      { name: "Talismans in Sunny Beach, Skelos Badlands & Scorch", types: [] of String },
    ...
    [
      ...
      { name: "4+ orbs in Skelos Badlands & Mystic Marsh", types: [] of String },
      { name: "650 combined gems in Glimmer & Skelos Badlands", types: [] of String },
      { name: "Seaweed Skill Point", types: [] of String },
    ...
    [
      ...
      { name: "4+ orbs in Glimmer & Sunny Beach", types: [] of String },
      { name: "Buy Swim with 8+ orbs", types: [] of String },
      { name: "Use all fireball powerups", types: [] of String },
    ...
    [
      ...
      { name: "Plant all seeds in Zephyr", types: [] of String },
      { name: "600 combined gems in Magma Cone & Aquaria Towers", types: [] of String },
      { name: "12 Summer Forest orbs", types: [] of String },
    ...
    [
      ...
      { name: "Pay Moneybags 7 times", types: [] of String },
      { name: "250 gems in both Glimmer & Metropolis", types: [] of String },
      { name: "Use all superfly powerups", types: [] of String },
    ...
    [
      ...
      { name: "250 gems in both Idol Springs & Cloud Temples", types: [] of String },
      { name: "Use all '14' powerups", types: ["14p"] },
      { name: "All enemies in Aquaria Towers", types: [] of String },
    ...
    [
      ...
      { name: "300 gems in both Idol Springs and Colossus", types: [] of String },
      { name: "Use all spring powerups", types: [] of String },
      { name: "2 Professor orbs", types: [] of String },
    ...
    [
      ...
      { name: "Hockey Skill Point", types: [] of String },
      { name: "Use all '18' powerups", types: ["18p"] },
      { name: "All enemies in Mystic Marsh", types: [] of String },
    ...
    [
      ...
      { name: "5+ orbs in Cloud Temples & Metropolis", types: [] of String },
      { name: "600 combined gems in Fracture Hills & Metropolis", types: [] of String },
      { name: "All enemies in Scorch", types: [] of String },
    ...
    [
      ...
      { name: "Use all '20' powerups", types: ["20p"] },
      { name: "250 gems in both Scorch & Fracture Hills", types: [] of String },
      { name: "Use 5 unique powerup types", types: [] of String },
    ...
    [
      ...
      { name: "20 orbs", types: [] of String },
      { name: "20 orbs", types: [] of String },
      { name: "2000 gems", types: [] of String },
      { name: "2000 gems", types: [] of String },
    ...
    [
      ...
      { name: "Speak to Brother Curtis with 4+ talismans & 4+ orbs", types: [] of String },
      { name: "250 gems in both Sunny Beach & Breeze Harbor", types: [] of String },
      { name: "All end of level orbs", types: [] of String },
    ...
    [
      ...
      { name: "All enemies in Fracture Hills", types: [] of String },
    ...
    [
      ...
      { name: "4+ orbs in Colossus & Fracture Hills", types: [] of String },
      { name: "650 combined gems in Hurricos & Fracture Hills", types: [] of String },
      { name: "All enemies in Zephyr", types: [] of String },
    ...
    [
      ...
      { name: "Use all '15' powerups", types: ["15p"] },
      { name: "600 combined gems in Crystal Glacier and Robotica Farms", types: [] of String },
      { name: "Unlock Cloud Temples", types: [] of String },
